...
var $author$project$Data$Resources$update = F2(
	function (resourcesData, resourcesUpdate) {
		switch (resourcesUpdate.$) {
			case 'UpdateCanClick':
				var resource = resourcesUpdate.a;
				var bool = resourcesUpdate.b;
				return (resource === 'grain') ? _Utils_update(
					resourcesData,
					{canClickGrain: bool}) : ((resource === 'wood') ? _Utils_update(
					resourcesData,
					{canClickWood: bool}) : _Utils_update(
					resourcesData,
					{canClickStone: bool}));
			case 'UpdateDelay':
				var resource = resourcesUpdate.a;
				var time = resourcesUpdate.b;
				return (resource === 'grain') ? _Utils_update(
					resourcesData,
					{grainDelay: time}) : ((resource === 'wood') ? _Utils_update(
					resourcesData,
					{woodDelay: time}) : _Utils_update(
					resourcesData,
					{stoneDelay: time}));
			case 'UpdateGetAmount':
				var resource = resourcesUpdate.a;
				var amount = resourcesUpdate.b;
				return (resource === 'grain') ? _Utils_update(
					resourcesData,
					{grainGetAmount: amount}) : ((resource === 'wood') ? _Utils_update(
					resourcesData,
					{woodGetAmount: amount}) : _Utils_update(
					resourcesData,
					{stoneGetAmount: amount}));
			default:
	...
	function (msg, model) {
		...
		while (true) {
			switch (_v0.b.$) {
				case 'ResourcesMsg':
					if (_v0.a.$ === 'Resources') {
						var resourcesModel = _v0.a.a;
						var resourcesMsg = _v0.b.a;
						return A4(
				...
				case 'ToTab':
					...
					var tab = _v0.b.a;
					return _Utils_eq(tab, currentTab) ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{currentTab: tab}),
						$elm$core$Platform$Cmd$none);
...
var $author$project$Tabs$Explore$view = F2(
								...
								[
									...
									_List_fromArray(
										[
											...
											_Utils_update(
												$author$project$Tabs$Explore$padding,
												{top: 20}))
										]),
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text(
											'Cost: ' + ($elm$core$String$fromInt(sharedState.exploreData.wanderCost) + ' grain'))
										])),
									A2(
...
var $author$project$Tabs$Resources$endAppend = F2(
...
var $author$project$Tabs$Resources$view = F2(
	function (model, sharedState) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$size(15),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'margin-left', '25vw')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'margin-top', '7vh'))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Border$width(1),
									A2($mdgriffith$elm_ui$Element$paddingXY, 20, 15),
									$mdgriffith$elm_ui$Element$Border$rounded(3),
									$author$project$Tabs$Resources$noOutline,
									sharedState.resourcesData.canClickGrain ? $mdgriffith$elm_ui$Element$Background$color(
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Border$rounded(3),
									$author$project$Tabs$Resources$noOutline,
									sharedState.resourcesData.canClickWood ? $mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1)) : $mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb255, 169, 169, 169))
								]),
							{
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$Border$rounded(3),
									$author$project$Tabs$Resources$noOutline,
									sharedState.resourcesData.canClickStone ? $mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb, 1, 1, 1)) : $mdgriffith$elm_ui$Element$Background$color(
									A3($mdgriffith$elm_ui$Element$rgb255, 169, 169, 169))
								]),
							{
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'margin-right', '10vw')),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'top', '-43px'))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(
									A2(
										$author$project$Tabs$Resources$endAppend,
										' grain',
										$elm$core$String$fromInt(sharedState.grainAmount)))
								])),
							(sharedState.woodAmount > 0) ? A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_fromArray(
								[
									A2($mdgriffith$elm_ui$Element$paddingXY, 20, 15)
							...
							_List_fromArray(
								[
									...
									A2(
										$author$project$Tabs$Resources$endAppend,
										' wood',
										$elm$core$String$fromInt(sharedState.woodAmount)))
								])) : $mdgriffith$elm_ui$Element$none,
							(sharedState.stoneAmount > 0) ? A2(
							$mdgriffith$elm_ui$Element$paragraph,
							_List_fromArray(
								[
									A2($mdgriffith$elm_ui$Element$paddingXY, 20, 15)
...
var $author$project$Main$noOutline = $mdgriffith$elm_ui$Element$htmlAttribute(
	A2($elm$html$Html$Attributes$style, 'box-shadow', 'none'));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('Resources'),
					onPress: $elm$core$Maybe$Just(
				...
				{
					label: $mdgriffith$elm_ui$Element$text('Explore'),
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$ToTab(
